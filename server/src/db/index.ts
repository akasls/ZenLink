...
export async function initDatabase(): Promise<void> {
  ...
  try { db.run("ALTER TABLE ai_conversations ADD COLUMN is_pinned INTEGER DEFAULT 0;"); } catch {}
  try { db.run("ALTER TABLE ai_conversations ADD COLUMN is_archived INTEGER DEFAULT 0;"); } catch {}
  // 性能索引加速
